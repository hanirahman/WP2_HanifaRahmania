<section>
    ...
    tadi menjelaskan bahwa codeigneter menggunakan metode MVC. Apa itu
    ...
    komponen utama menjadi 3 komponen yaitu model, view dan
    controller</p>

    <ol type="a">
        <li>Model</li>
        <p align="justify">Model adlah kelas yang mempresentasikan atau 
        ...
        dari database, menginput dan pengolahan databse lainnya. semua
        ...
        interface atau halamn yang sering muncul pada user(pada browser). Tampilan
        dari user interface di kumpulkan pada view untuk memisahkannya dengan controller dan model sehingga memdahkan web designer 
